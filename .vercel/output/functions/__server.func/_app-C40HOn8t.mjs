...
import { u as useStore, R as ROLE_LABELS } from "./_ssr/router-BtGSnx8t.mjs";
import "./_libs/sonner.mjs";
import { F as Feather, L as LayoutDashboard, t as Warehouse, B as Bird, E as Egg, u as Wheat, H as HeartPulse, P as Package, a as Boxes, m as ShoppingCart, s as Users, W as Wallet, C as Calendar, e as FileChartColumnIncreasing, l as Settings, g as LogOut, h as PanelLeft, X } from "./_libs/lucide-react.mjs";
...
const menu = [
  ...
  { title: "Laporan", url: "/laporan", icon: FileChartColumnIncreasing },
...
function AppSidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "border-b border-sidebar-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-2 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Feather, { className: "h-5 w-5" }) }),
      !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-sidebar-foreground", children: "Telurku" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-sidebar-foreground/60", children: "Management System" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: menu.map((m) => {
        const active = path === m.url || path.startsWith(m.url + "/");
        return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: active, tooltip: m.title, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: m.url, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(m.icon, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: m.title })
        ] }) }) }, m.url);
      }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarFooter, { className: "border-t border-sidebar-border", children: [
      currentUser && !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2 py-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-sidebar-foreground", children: currentUser.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-sidebar-foreground/60", children: ROLE_LABELS[currentUser.role] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            ...
            !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Keluar" })
          ]
        }
      )
    ] })
...
function AppLayout() {
  ...
  if (!currentUser) return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/login" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen w-full bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 flex h-14 items-center justify-between border-b bg-background/80 px-4 backdrop-blur", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarTrigger, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground hidden sm:inline", children: "Telurku Management System" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-muted-foreground", children: ROLE_LABELS[currentUser.role] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-full bg-primary/15 text-primary font-semibold", children: currentUser.name.charAt(0) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 p-4 sm:p-6 space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
    ] })
  ] }) });
}
export {
