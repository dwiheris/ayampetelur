...
import { u as useStore, a as formatRupiah } from "./router-BtGSnx8t.mjs";
...
const kategoriOut = ["Pakan", "Obat & Vitamin", "Gaji Karyawan", "Listrik", "Air", "Transport", "Perawatan Kandang", "Lainnya"];
...
function KeuanganPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "Keuangan", description: "Pemasukan, pengeluaran, dan laba rugi.", actions: /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange: (v) => {
      setOpen(v);
      if (!v) setEdit(empty);
    }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Transaksi Baru" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: edit.jenis, onValueChange: (v) => setEdit({
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Pemasukan", children: "Pemasukan" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Pengeluaran", children: "Pengeluaran" })
                ] })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: edit.kategori, onValueChange: (v) => setEdit({
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: (edit.jenis === "Pemasukan" ? kategoriIn : kategoriOut).map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: k, children: k }, k)) })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Jumlah" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase text-muted-foreground", children: "Total Pemasukan" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-2xl font-bold text-success", children: formatRupiah(pemasukan) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase text-muted-foreground", children: "Total Pengeluaran" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-2xl font-bold text-destructive", children: formatRupiah(pengeluaran) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase text-muted-foreground", children: "Laba Bersih" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `mt-2 text-2xl font-bold ${laba >= 0 ? "text-success" : "text-destructive"}`, children: formatRupiah(laba) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Riwayat Transaksi" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Catatan" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: [...transaksi].sort((a, b) => b.tanggal.localeCompare(a.tanggal)).map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: t.tanggal }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: t.jenis === "Pemasukan" ? "default" : "destructive", children: t.jenis }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: t.kategori }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: t.catatan }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: `text-right font-semibold ${t.jenis === "Pemasukan" ? "text-success" : "text-destructive"}`, children: [
            t.jenis === "Pemasukan" ? "+" : "−",
